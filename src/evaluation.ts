// adapted from https://dev.to/zeyu2001/build-a-simple-chess-ai-in-javascript-18eg
...
export function evaluateBoard(move: Move, prevSum: number, color: Color) {
  var from = [8 - parseInt(move.from[1]), move.from.charCodeAt(0) - aValue];
  var to = [8 - parseInt(move.to[1]), move.to.charCodeAt(0) - aValue];
